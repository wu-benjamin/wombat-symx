...
pub fn get_backward_edges(function: &FunctionValue) -> HashMap<String, HashSet<String>> {
...
pub fn forward_topological_sort(function: &FunctionValue) -> Vec<String> {
...
pub fn backward_topological_sort(function: &FunctionValue) -> Vec<String> {
